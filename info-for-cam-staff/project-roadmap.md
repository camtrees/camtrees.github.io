...
<details markdown="1">
<summary markdown="span">Timeframe: Title</summary>
...
<details markdown="1">
<summary markdown="span">Fall/Winter: Use GitHub as a long-term photo repository instead of EpiCollect</summary>
...
<details markdown="1">
<summary markdown="span">Ongoing: After any Python Import code testing, delete any records
created by the database administrator for testing</summary>
...
<details markdown="1">
<summary markdown="span">Fall/Winter: Evaluate cloud-based solutions (such as GitHub Actions) for running Python scripts</summary>
...
<details markdown="1">
<summary markdown="span">In Progress: Add additional 'missing_data' views</summary>

**Purpose:**
Will assist users to identify and help fill gaps in the data.
...
<details markdown="1">
<summary markdown="span">Next Up: Allow CAMorgs, and Sites to have multiple contact persons</summary>
...
<details markdown="1">
<summary markdown="span">Short-term Goal: Complete as much of the database missing data as possible</summary>
...
<!--------------------------------------------------------------------------------------->
<details markdown="1">
<summary markdown="span">Short-term Goal: Document how CAM volunteers and staff can access the CAMTREES database using DBeaver</summary>
...
<details markdown="1">
<summary markdown="span">Future Project: Create a view that shows the tree photos from the first and last visit each year</summary>
...
<details markdown="1">
<summary markdown="span">Future Project: Create a view that shows the proximity of dead and poor trees</summary>
...
<details markdown="1">
<summary markdown="span">Future Project: CAM staff needs web access to the CAMTREES database</summary>
